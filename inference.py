...
def parse_args():
    ...
    parser.add_argument("--target_dir", type=str, default="./data/RGB-NIR/tiff2png/train/noise")
    parser.add_argument("--guide_dir", type=str, default="./data/RGB-NIR/tiff2png/train/nir")
